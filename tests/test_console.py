...
class TestHBNBCommand(unittest.TestCase):
    ...
    def test_create_command_with_kwargs(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            call = (f'create Place city_id="0001" name="My_little_house" number_rooms=4 latitude=37.76 longitude=43.435')  # noqa
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            ...
            self.assertIn("'latitude': 37.76", output)
            self.assertIn("'longitude': 43.435", output)
